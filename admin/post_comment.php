    ...
    <div id="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <?php
                    $query = "SELECT post_title FROM posts WHERE post_id = $the_post_id";
                    $select_post = mysqli_query($connection, $query);
                    $post_title_array = mysqli_fetch_row($select_post);
                    $post_title = $post_title_array['0'];
                    ?>
                    <h1 class="page-header">
                        <?php echo "<a href = '../post/$the_post_id' >$post_title</a>"?> Comments Section
                    </h1>
                    ...
                    if($comments_count == 0) {
                    echo "<h3>This post has no comments</h3>";
                    } else { ?>
