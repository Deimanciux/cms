                    ...
                    <script type="text/javascript">
                        ...
                        function drawChart() {
                            var data = google.visualization.arrayToDataTable([
                                ...
                                $element_count = [$post_count, $post_published_count, $post_draft_count, $comments_count, $unapproved_comment_count, $users_count, $subscribers_count, $categories_count];
